...
2. Install [EnvCLI](https://dl.bintray.com/envcli/golang/envcli/v0.5.1/EnvCLI-amd64.msi)
...
```bash
curl -L -o /usr/local/bin/envcli https://dl.bintray.com/envcli/golang/envcli/v0.5.1/envcli_linux_386
...
```bash
curl -L -o /usr/local/bin/envcli https://dl.bintray.com/envcli/golang/envcli/v0.5.1/envcli_linux_amd64
chmod +x /usr/local/bin/envcli
```

#### **Docker Toolbox (Legacy)**

Install [EnvCLI](https://dl.bintray.com/envcli/golang/envcli/v0.5.1/EnvCLI-amd64.msi)
